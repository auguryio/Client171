...
public final class Widget {
	...
	//Skill tab by Oak & Removed by Jparks Roatzpk Tab
	public static void skillTab(GameFont[] tda) {
		...
		addText(52022, "@or1@Hitpoints", tda, 0, 00000, false, true);
		addText(52023, "@or1@Attack", tda, 0, 00000, false, true);
		addText(52052, "@or1@Strength", tda, 0, 00000, false, true);
		addText(52025, "@or1@Defence", tda, 0, 00000, false, true);
		addText(52026, "@or1@Ranged", tda, 0, 00000, false, true);
		addText(52027, "@or1@Magic", tda, 0, 00000, false, true);
		addText(52028, "@or1@Prayer", tda, 0, 00000, false, true);
	...
	public static void pvpTab(GameFont[] tda) {
		...
		addText(32026, "@or1@Top Donators - Best Support", tda, 2, 0xFFFFFF, false, true);
	...
	public static void settingsTab() {
		...
		addButton(42511, 42500, 40, 40, interfaceCache[19156].disabledSprite, interfaceCache[19156].enabledSprite, -1, "Key Bindings");
	...
	public static void ancientSpellbookEdit(GameFont[] t) {
		...
		setBounds(12901, 25, 10, 0, tab);
		setBounds(12861, 65, 10, 1, tab);
		setBounds(13045, 105, 10, 2, tab);
		setBounds(12963, 145, 10, 3, tab);

		//Row 2
		setBounds(13011, 25, 45, 4, tab);
		setBounds(13045, 65, 45, 5, tab);
		setBounds(12919, 105, 45, 6, tab);
		setBounds(12881, 145, 45, 7, tab);

		//Row 3
		setBounds(13045, 25, 85, 8, tab);
		setBounds(12951, 65, 85, 9, tab);
		setBounds(12999, 105, 85, 10, tab);
		setBounds(13045, 145, 85, 11, tab);

		//Row 4
		setBounds(12911, 25, 115, 12, tab);
		setBounds(12871, 65, 115, 13, tab);
		setBounds(13045, 105, 115, 14, tab);
		setBounds(13045, 145, 115, 15, tab);


		//Row 5
		setBounds(12975, 25, 145, 16, tab);
		setBounds(13023, 65, 145, 17, tab);
		setBounds(13045, 105, 145, 18, tab);
		setBounds(12929, 145, 145, 19, tab);
		//Row 6 JPARKS
		setBounds(12891, 25, 180, 20, tab);
		setBounds(13045, 65, 180, 21, tab);
		setBounds(13045, 115, 200, 22, tab);
		...
		//Row 1
		setBounds(21758, 3, 180, 22, tab);
		setBounds(21793, 3, 180, 23, tab);
		setBounds(21874, 3, 180, 24, tab);
		setBounds(21903, 3, 180, 25, tab);

		//Row 2
		setBounds(21988, 3, 180, 26, tab);
		setBounds(22018, 3, 180, 27, tab);
		setBounds(22068, 3, 180, 28, tab);
		setBounds(22093, 3, 180, 29, tab);

		//Row 3
		setBounds(22169, 3, 180, 30, tab);
		setBounds(22198, 3, 180, 31, tab);
		setBounds(22252, 3, 180, 32, tab);
		setBounds(22277, 3, 180, 33, tab);

		//Row 4
		setBounds(22352, 3, 10, 34, tab);
		setBounds(22381, 3, 10, 35, tab);
		setBounds(22431, 3, 10, 36, tab);
		setBounds(22460, 3, 10, 37, tab);
		setBounds(22460, 3, 10, 38, tab);
	...
	public static void constructLunar() {
		...
		//Row 2
		setBounds(30099, 8, 60, 6, Interface);
		setBounds(30122, 39, 61, 7, Interface);
		setBounds(30130, 71, 61, 8, Interface); 
		setBounds(30154, 103, 61, 9, Interface);
		setBounds(30178, 135, 61, 10, Interface); 
		setBounds(30186, 165, 59, 11, Interface);
		//Row 3
		setBounds(30194, 12, 111, 12, Interface);
		setBounds(30202, 42, 110, 13, Interface);
		setBounds(30210, 71, 110, 14, Interface);
		setBounds(30218, 103, 110, 15, Interface);
		setBounds(30242, 135, 110, 16, Interface);
		setBounds(30282, 165, 110, 17, Interface);
		//Row 4
		setBounds(30290, 11, 160, 18, Interface);//
		setBounds(30298, 41, 160, 19, Interface);//
		setBounds(13045, 100, 160, 21, Interface);
		setBounds(30306, 70, 160, 20, Interface);
